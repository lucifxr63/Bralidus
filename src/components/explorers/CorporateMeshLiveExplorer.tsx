      ...
      <div style={{ padding: 28 }}>
        ...
        {activeTab === 'representatives' && (
          <div style={{ background: '#0B0B1D', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, padding: 24 }}>
            ...
            <div style={{ background: '#05050C', border: '1px solid rgba(45,212,191,0.2)', borderRadius: 12, padding: 18 }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
                <div>
                  <span style={{ fontSize: 15, fontWeight: 800, color: '#F1F5F9' }}>Luciano Alonso Larraín</span>
                  <span style={{ fontSize: 12, color: '#2DD4BF', marginLeft: 10, fontWeight: 700 }}>RUT: 14.567.890-2</span>
                </div>
          ...
          <div style={{ background: '#0B0B1D', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, padding: 24 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 16 }}>
              <div style={{ background: '#05050C', padding: 16, borderRadius: 12, border: '1px solid rgba(255,255,255,0.06)' }}>
                ...
                <span style={{ fontSize: 18, fontWeight: 800, color: '#4ADE80', display: 'block', marginTop: 4 }}>0 COINCIDENCIAS</span>
                <span style={{ fontSize: 11, color: '#94A3B8' }}>Ningún socio es Persona Expuesta Políticamente</span>
              </div>

              <div style={{ background: '#05050C', padding: 16, borderRadius: 12, border: '1px solid rgba(255,255,255,0.06)' }}>
                <span style={{ fontSize: 12, fontWeight: 700, color: '#64748B' }}>COMPETIDORES CON SOCIOS COMUNES</span>
                <span style={{ fontSize: 18, fontWeight: 800, color: '#F59E0B', display: 'block', marginTop: 4 }}>1 DETECTADO</span>
                <span style={{ fontSize: 11, color: '#94A3B8' }}>Equipamiento Hospitalario Ltda (4 licitaciones compartidas)</span>
              </div>
            </div>
          </div>
        )}
